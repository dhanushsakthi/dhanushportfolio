          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-semibold shrink-0 transition-all duration-200 ${
                  isActive
              ...
              >
                <div className="flex items-center justify-between gap-2 mb-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <h3 className="font-bold text-slate-100 text-xs sm:text-sm group-hover:text-cyan-300 transition-colors truncate">
                      {skill.name}
                    </h3>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between border-t border-slate-800/60 pt-2.5 text-[11px]">
                  ...
                  {skill.level && (
                    <span className="px-2 py-0.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 font-semibold shrink-0">
                      {skill.level}
                    </span>
                  )}
                </div>
